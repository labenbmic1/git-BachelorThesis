...
\usepackage[todo=true]{tum-physics}%
...
\TUMsetindexpreamble{%
	main={Die unerfahrenen Freunde sind gefährlich. Klugheit ist besser, selbst in einem Feind. Unterstrichene Zahlen (\texttt{idxnumber2}) verweisen auf die Definition, fett hervorgehobene (\texttt{idxnumber(1)}) geben Seiten der Erklärung zum jeweiligen Stichwort wieder und normal gedruckte verweisen hingegen auf Seiten mit zusätzlichen Informationen.\par\bigskip}%
% Numbers underlined point to the definition, bold numbers denote the pages where the corresponding entry is described and all others indicate the places where it is used.
}%
%% Multiple Indices:
